...
class Trainer() :
    def __init__(self, **kwargs) :
        ...
        self.resnet = make_resnet(kwargs["num_category"], kwargs["num_layers"], kwargs["zero_padding"], kwargs["bn_momentum"])
    ...
    def train(self) :
        self.opt = tf.keras.optimizers.SGD(lr = self.lr, momentum = self.sgd_momentum)
