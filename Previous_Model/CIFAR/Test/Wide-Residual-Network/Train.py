...
from LearningRateScheduler import SpecificLearningRateScheduler
...
def train(**kwargs) :
    ...
    model.compile(optimizer = tf.keras.optimizers.SGD(
        lr = tf.Variable(0.1, trainable = False), momentum = 0.9, nesterov = True),
    ...
    callback_list = [
        ...
        SpecificLearningRateScheduler(0)
    ]
