...
parser.add_argument('-n', '--num_layers', type = int, default = 164,
    help = r'ResNet-{num_layers}' + '\n' +
        '(num_layers - 2)가 6 또는 9의 배수가 아니라면 Error 발생\n' +
        'type : int - default : 164\n\n')

parser.add_argument('-b', '--bottleneck', type = True_False_check, default = True,
