...
parser.add_argument('-w', '--kernel_width', type = int, default = 10,
    help = "kernel width\n" + "type : int - default : 10\n\n")

parser.add_argument('-m', '--momentum', type = float, default = 0.9,
    help = 'batch normalization의 momentum 값\n' + 'type : float - default : 0.9\n\n')

parser.add_argument('-D', '--dropout_rate', type = float, default = 0.3,
    help = 'Residual Block에서 Conv2D 사이에 위치하는 Dropout layer의 rate 값\n' +
